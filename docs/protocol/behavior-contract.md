...
| BC-20 | 缺 `exclude` 字段视为 `[]`, 不判损坏; `roots` 必填                                                   | config-and-initialization.md「配置规格」                           | ✓                                                                                |
...
| BC-30 | `--help` 退 0, 含命令面 / `--exclude` 匹配口径 / 默认配置位置                                        | cli-surface.md「命令面」; config-and-initialization.md「配置规格」 | ✓                                                                                |
